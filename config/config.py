...
## path
path = edict()
path.train_path = "/home/zhangtianhan/datasets/waxGourd/unfreedom_split/train" # used in visualDet3D/data/.../dataset
path.test_path = "/home/zhangtianhan/datasets/waxGourd/unfreedom_split/test" # used in visualDet3D/data/.../dataset
path.visualDet3D_path = "/home/zhangtianhan/codes/MonoDTR_plant/visualDet3D" # The path should point to the inner subfolder
path.project_path = "/home/zhangtianhan/codes/MonoDTR_plant/workdirs" # or other path for pickle files, checkpoints, tensorboard logging and output files.
...
head_loss = edict(
    ...
    regression_weight = [1, 1, 1, 1, 1, 1, 40, 1, 1, 0.5, 0.5, 0.5, 1], #[x, y, w, h, cx, cy, z, sin2a, cos2a, w, h, l]
)
head_test = edict(
    score_thr=0.75,
    cls_agnostic = False,
