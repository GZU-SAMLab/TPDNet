...
def write_result_to_file(base_result_path:str, 
                        filename:str, scores, bbox_2d, bbox_3d_state_3d=None, thetas=None, obj_types=['Car', 'Pedestrian', 'Cyclist'], threshold=0.4):
    ...
    name = filename
    # imdb_path = base_result_path+'imdb_path'
    # imdb=pickle.load(open(imdb_path, 'rb')) 
    ...
    if bbox_3d_state_3d is None:
        ...
        for i in range(len(bbox_2d)):
            bbox_3d_state_3d[i][1] = bbox_3d_state_3d[i][1] # kitti receive bottom center
