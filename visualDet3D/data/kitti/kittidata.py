...
class KittiData:
    ...
    def __init__(self, root_dir, idx, output_dict=None):
        ...
        '''
        self.calib_path = os.path.join(root_dir,'calib.txt')
        self.image2_path = os.path.join(root_dir, "RGB", idx+'.jpg')
        self.image3_path = os.path.join(root_dir, 'image_3', idx+'.jpg')
        self.label2_path = os.path.join(root_dir, "Label", idx+'.txt')
        self.velodyne_path = os.path.join(root_dir, "BIN", idx+'.bin')
