...
def main(config:str="/home/zhangtianhan/codes/MonoDTR_plant/config/config.py",
        gpu:int=0, 
        checkpoint_path:str="/home/zhangtianhan/codes/MonoDTR_plant_2crossAttention+selfAteention/Model/MonoDTR_259.pth",
    ...
    detector.eval()
    Image = Image.open("/home/zhangtianhan/datasets/waxGourd/new_freedom_split/test/RGB/neuvsnap_0906_105457.jpg")